...
(() => {
  ...
  if (!page.active) {
    root.innerHTML =
      '<section class="section"><div class="container"><div class="public-empty-state"><i data-lucide="eye-off"></i><h1 class="t-h2">FAQ tidak tersedia</h1><p>Halaman bantuan sedang dinonaktifkan.</p><a class="btn btn--outline" href="index.html">Kembali ke Beranda</a></div></div></section>';
    lucide.createIcons();
    return;
  }
