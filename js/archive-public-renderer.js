...
(() => {
  ...
  if (!page.active) {
    root.innerHTML = '<section class="section"><div class="container"><div class="public-empty-state"><i data-lucide="eye-off"></i><h1 class="t-h2">Arsip tidak tersedia</h1><p>Halaman Arsip sedang dinonaktifkan.</p><a class="btn btn--outline" href="index.html">Kembali ke Beranda</a></div></div></section>';
