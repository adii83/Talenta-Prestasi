...
function normalizeGlobalSettings(source) {
  ...
  b.theme = {
    ...
    accentColor: source.accentColor || b.theme.accentColor,
  };
  b.navigation = {
  ...
  return (
    {
      "index.html": "home",
      "unduh.html": "download",
      "pemenang.html": "winners",
      "arsip.html": "archive",
      "arsip-detail.html": "archive",
      "faq.html": "faq",
    }[file] || null
  );
}
...
function getFirstEnabledPublicPage(s = getGlobalSettings()) {
  return "index.html";
}
